        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div class="space-y-4 text-gray-600">
              ...
              <p>
                Over the years, we've built strong relationships with premium partners worldwide, allowing us to offer 
                exclusive experiences and unparalleled service to our clients.
              </p>
              <p>
                Today, we continue to innovate and enhance our services, always putting our clients' dreams and satisfaction first.
              </p>
            </div>
          </div>
          <div class="relative">
            ...
            />
            <div class="absolute -bottom-6 -left-6 bg-primary text-white p-4 rounded-lg">
      ...
      <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="card p-6">
            ...
            <p class="text-gray-600">
              Our passion for travel drives us to create unique and memorable experiences for our clients.
            </p>
          </div>

          <div class="card p-6">
            <div class="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mb-4">
              <mat-icon class="text-primary">handshake</mat-icon>
            </div>
            <h3 class="text-xl font-bold mb-2">Trust</h3>
            <p class="text-gray-600">
              Building lasting relationships through transparency and reliability is at our core.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div class="text-center">
            <div class="relative mb-4 group">
              ...
              />
              <div class="absolute inset-0 bg-primary/0 group-hover:bg-primary/20 transition-colors rounded-lg"></div>
            </div>
